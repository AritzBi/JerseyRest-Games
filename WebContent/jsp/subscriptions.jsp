...
<html>
	...
	<body>
		...
		<br/><br/>
		<b>
		<s:url id="urlAnyadir" action="insertSubscription" escapeAmp="false">>
		...
		<table class="borderAll">
		    ...
		    <s:iterator value="subscriptions" status="status">
		        <tr class="<s:if test="#status.even">even</s:if><s:else>odd</s:else>">
		            ...
		            <td>
		           	<s:url id="URLClientesSubscription" action="clients.action">
		            ...
		            <s:url id="URLeditSubscription" action="editSubscription!goToEditSubscription.action">
		            ...
		            <s:url id="URLDeleteSubscription" action="deleteSubscription.action">
